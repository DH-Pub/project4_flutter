...
enum MENU_DRAWER_LINKS { chooseTeam, teamDetail, userSettings, projectDetail }
...
extension LinksExtension on MENU_DRAWER_LINKS {
  static Map<MENU_DRAWER_LINKS, String> goNamed = {
    ...
    MENU_DRAWER_LINKS.projectDetail: APP_PAGE.projects.toName,
  };
  static Map<MENU_DRAWER_LINKS, String> title = {
    ...
    MENU_DRAWER_LINKS.projectDetail: "Project Detail",
  };
}
