...
enum MENU_DRAWER_LINKS { chooseTeam, teamDetails, userSettings }
...
extension LinksExtension on MENU_DRAWER_LINKS {
  static Map<MENU_DRAWER_LINKS, String> goNamed = {
    ...
    MENU_DRAWER_LINKS.teamDetails: APP_PAGE.team.toName,
  ...
  static Map<MENU_DRAWER_LINKS, String> title = {
    ...
    MENU_DRAWER_LINKS.teamDetails: "Team Details",
